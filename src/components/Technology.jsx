    ...
    <div className="pt-[5.2rem] xl:pt-[7.3rem] bg-[url('/img/technology/background-technology-mobile.jpg')] sm:bg-[url('/img/technology/background-technology-tablet.jpg')] lg:bg-[url('/img/technology/background-technology-desktop.jpg')] w-full h-[100vh] bg-cover">
      <main className="w-full lg:max-w-[1440px] h-full flex flex-col items-center pt-[1.5rem] md:pt-[2.5rem]  lg:pl-[9.41rem] lg:pt-[4.1rem] lg:pb-[7rem] xl:mx-auto xl:pl-[13.41rem] box-border">
        <div className="w-full text-center md:text-left md:px-[2.41rem] lg:md:px-0">
          <h1 className=" text-[#fff] text-[16px] uppercase font-fontBarlowCondense  tracking-[0.16875rem]  md:text-[1.15rem] lg:text-[1.75rem] xl:text-[28px]">
        ...
        <div className="relative w-full h-full  md:max-w-[100vw] lg:pl-[9rem] mx-auto pt-[2rem] ">
          <div className=" flex flex-nowrap overflow-hidden w-full h-full flex-1 cursor-pointer user-select-none">
            <div className="min-w-full w-full h-full flex flex-col items-center gap-[5rem] justify-start py-transition-all  duration-1000 ease-custom lg:flex-row-reverse lg:items-start lg:gap-0 md:gap-[9rem] xl:border-l border-[#e5e7eb] border-opacity-[0.25]">
              ...
              <div className="text-center text-[#fff] max-w-[87vw]  lg:flex-1 lg:text-left lg:mt-[9.62rem] ">
                ...
                <p className="mt-[1rem] leading-[1.5625rem] text-[0.9375rem] font-fontBarlow md:text-[16px] md:w-[26.925rem] md:h-[125px] lg:text-[18px] lg:leading-[2rem] lg:w-[26.25rem] lg:h-[160px] lg:mt-0 xl:h-[192px] xl:leading-[1.8rem]">
                  {techno.description}
                </p>
              </div>
            </div>
